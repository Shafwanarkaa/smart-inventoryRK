                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        >
                            ...
                            <option value="5" {{ old('nilai_c2') == 5 ? 'selected' : '' }}>5 - Sangat Mudah Basi (Sayuran, Ikan segar, Susu)</option>
                            <option value="4" {{ old('nilai_c2') == 4 ? 'selected' : '' }}>4 - Mudah Basi (Tahu, Tempe, Daging)</option>
                            <option value="3" {{ old('nilai_c2') == 3 ? 'selected' : '' }}>3 - Cukup Tahan (Telur, Buah, Roti)</option>
                            <option value="2" {{ old('nilai_c2') == 2 ? 'selected' : '' }}>2 - Tahan Lama (Bumbu basah, Kecap)</option>
                    ...
                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        ...
                        >
                            ...
                            <option value="5" {{ old('nilai_c3') == 5 ? 'selected' : '' }}>5 - Sangat Tinggi (dipakai setiap menu, hampir tidak bisa diganti)</option>
                            <option value="4" {{ old('nilai_c3') == 4 ? 'selected' : '' }}>4 - Tinggi (dipakai di banyak menu setiap hari)</option>
                            <option value="3" {{ old('nilai_c3') == 3 ? 'selected' : '' }}>3 - Sedang (dipakai beberapa menu per hari)</option>
                            <option value="2" {{ old('nilai_c3') == 2 ? 'selected' : '' }}>2 - Rendah (dipakai sesekali atau menu tertentu saja)</option>
                            <option value="1" {{ old('nilai_c3') == 1 ? 'selected' : '' }}>1 - Sangat Rendah (jarang dipakai, bisa diganti)</option>
                        </select>
                        <div class="mt-3 grid grid-cols-5 gap-1 text-xs">
