...
@section('page-subtitle', 'Perbarui data supplier bahan baku.')
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-bold text-gray-800">Form Edit Supplier</h3>
        </div>

        <form action="{{ route('manajer.supplier.update', $supplier->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
